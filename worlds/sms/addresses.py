SMS_FLAGS_PTR =   0x8040E160 #Probably reorganize these somehow
LIVES_COUNT_OFFSET =    0x7C
BLUECOIN_COUNT_OFFSET = 0xD4
SHINE_COUNT_OFFSET =    0xD0
SHINE_LOC_OFFSET =      0x00
BLUECOIN_LOC_OFFSET =   0x0F
NOZZLE_BOXES_OFFSET =   0x6C
DELFINO_YOSHI_OFFSET =  0x71
